...
export default function CommunicationPanel() {
  ...
  const containerPointer = open ? "pointer-events-auto" : "pointer-events-none";

  return (
    <div className={`fixed top-20 left-3 z-40 ${containerPointer}`}>
      ...
      <motion.aside
        ...
        className={`mt-3 w-72 sm:w-80 rounded-2xl bg-white shadow-2xl border border-black/5 overflow-hidden flex flex-col max-h-[calc(100vh-140px)] ${
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto scrollbar-none">
                ...
                <div key={req.id} className="rounded-xl border border-gray-200 p-3 bg-white space-y-2">
                  ...
                  {req.direction === "incoming" ? (
                    ...
                    <div className="flex justify-end">
                      <span className="text-xs text-gray-500">Aguardando resposta do outro usuário</span>
                    </div>
                  )}
                </div>
              ))}
          ...
          <div className="px-4 py-3 flex items-center gap-2 text-xs overflow-x-auto bg-white border-b border-gray-100">
            <span className="text-gray-600">Filtrar por:</span>
            <button
              onClick={() => setFilter("todos")}
              className={`px-3 py-1 rounded-full border whitespace-nowrap ${
                filter === "todos" ? "bg-[#CDECF9] border-[#0e7490]" : "border-gray-200"
              }`}
            >
              Todos
            </button>
          ...
          <div className="divide-y divide-gray-100 max-h-[360px] overflow-y-auto scrollbar-none">
